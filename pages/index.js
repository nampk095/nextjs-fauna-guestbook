  ...
  return (
    <>
      <form className="flexxx relative my-4" onSubmit={onSubmit}>
        ...
        <input
          required
          className={cn(inputClasses, 'pl-4 pr-32 pt-10 mt-5 flex-grow')}
        ...
        <button
          className={cn(
            'flexxx items-center justify-center',
            'absolute right-1 top-1 px-4 font-bold h-8',
            'bg-blue-100 dark:bg-blue-700 text-blue-900',
            'dark:text-blue-100 rounded w-28'
          )}
          type="submit"
